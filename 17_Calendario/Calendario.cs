...
namespace _17_Calendario
{
    internal class Calendario
    {
        ...
        public void ImprimirCalendario()
        {
            ...
            List<Feriado> diasFeriados = RetornaFeriados(); // obtém os feriados do mês
            ...
            foreach (Feriado diasFeriado in diasFeriados)
            {
                if (diasFeriado != null)
                    Console.Write($"{diasFeriado.Dia:D2} - {diasFeriado.Descricao}\t");
            }
        }
        ...
        private List<Feriado> RetornaFeriados()
        {
            ...
            if ((Mes)CorpuChrist.Month == mes)
                feriados.Add(new Feriado(CorpuChrist.Day, "Corpus Christe"));
